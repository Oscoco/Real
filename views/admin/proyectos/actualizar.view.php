...
<head>
    ...
    <title>Actualizar proyecto | Real Brothers</title>
</head>

<body class="bg-gray-200" id="body-pd">

    <div class="pt-20 ">
        <h1 class="mt-4 text-center text-4xl">Actualizar registro</h1>
        <div class="py-2 mb-4">
            <p>Administrador / Proyectos Activo / <span class="text-blue-800">Actualizar registro</span></p>
        </div>
    </div>
    ...
    <section class="sm:mx-7">
            <div class="bg-white w-full  rounded-xl shadow-md p-8 mb-5">
                <div>
                    <h1 class="active-text text-2xl mb-4 ">Datos de la Posicion - actualizar</h1>
                </div>
                <form class="">
                    ...
                    <div class="flex sm:flex-nowrap flex-wrap items-center justify-start sm:justify-center">
                        ...
                        <button type="submit" class="w-full mx-0 sm:mx-4">
                            <a class="primary_btn w-full ">Actualizar <i class='bx bx-user-plus px-1'></i></a>
                        </button>
                    </div>
