...
<section class="flex justify-center">
    ...
    <div class="sm:mx-5 mx-5 p-4 w-full max-w-sm bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 md:p-8 font-bold">
        <form class="space-y-6 text-black" action="#">
            ...
            <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-2xl px-5 py-2.5 text-center">Entrar</button>
        </form> 
    </div>
</section>
