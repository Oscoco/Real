...
<body class=" bg-gray-200 font-bold px-0">
        <div class="text-center pb-4">
            ...
            <h2 class="text-xl pb-5">REAL BROTHERS SECURITY S.A DE C.V</h2>
        </div>
<section class="flex justify-center">
    <div class="p-4 w-full max-w-sm bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 md:p-8 font-bold">
        <form class="space-y-6 text-black" action="#">
            <h5 class="text-2xl text-center text-black">Inicio de Secesión</h5>
            <div>
