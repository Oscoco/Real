                ...
                <div class="py-2" x-data="{ show: true }">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute inset-y-0 right-0 flex items-center text-sm leading-5 ">
                            ...
                            <i class='bx bx-low-vision text-gray-700 eye-show' fill="none" @click="show = !show" :class="{'hidden': !show, 'block':show }"></i>

                            <i class='bx bx bxs-low-vision text-blue-600 eye-show' fill="none" @click="show = !show" :class="{'block': !show, 'hidden':show }"></i>
                        </div>
                    </div>
                </div>
