        ...
        <button onclick="toggleMenu()" class="w-max flex content-center items-center ">
            ...
            <div class="header__img ">
                <div class="p-1 ">
                    ...
                    if (file_exists($foto)) {
                    ?>
                        <img src="<?php print $foto ?>" class="p-1 w-8 h-8 rounded-full ring-2 ring-blue-800 dark:ring-gray-500">
                    <?php } else { ?>
                        SIN FOTO
                    <?php }
                    ?>
            ...
            <!-- <img class="" src="<?=PATH?>assets/img/perfil.jpg" alt="Bordered avatar"> -->
